...
local fire_off		=	img_add("FIRE_off.png", 217, 336, 54, 35)
local fault_off		=	img_add("FAULT_off.png", 202, 412, 81, 34)
local fire_on		=	img_add("FIRE_on.png", 216, 171, 59, 34)
local fault_on		=	img_add("FAULT_on.png", 203, 244, 82, 37)

--=============================================================================================
--=======================	LVARs	===================================================
--=============================================================================================
local eng_master 	=	{"L:INI_MIXTURE_RATIO1_HANDLE", "bool"}
local integ_light	=	{"L:INI_CKPT_LT_INTEG", "enum"}
local light_powered	=	{"L:INI_EFB2_POWERED", "bool"}
local eng1_fire		=	{"L:INI_ENG_1_FIRE", "bool"}
local eng1_fault	=	{"L:INI_ENG_1_FAULT", "bool"}
...
msfs_variable_subscribe(eng1_fire[1], eng1_fire[2],
						eng1_fault[1], eng1_fault[2],
...
MasterPosition = switch_add(nil, nil, 165, 148, 161, 322, 'VERTICAL', changePosition)
switch_set_position (MasterPosition, 0)
